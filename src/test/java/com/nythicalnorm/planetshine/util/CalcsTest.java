...
class CalcsTest {
    ...
    void planetDimPosToNormalizedVectorTest() {
        ...
        for (int i = -15; i <= 25; i ++) {
            ...
            Vector3d planetPos = PlanetBodyCalc.planetDimPosToNormalizedVector(pos, 6371000, rot, false);
            System.out.println("z:" + pos.z + ", Pos = " + planetPos);

            Vector2d reconvertedPos = PlanetBodyCalc.vectorToPlanetDimPos(planetPos, 6371000, rot);
