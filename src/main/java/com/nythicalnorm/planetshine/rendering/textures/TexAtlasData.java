package com.nythicalnorm.planetshine.rendering.textures;
...
public class TexAtlasData {
    ...
    public TexAtlasData() {
        this.atlasInUse = new boolean[LodTexCalc.texInOneAxisCount][LodTexCalc.texInOneAxisCount];
        pos2AtlasPosMap = new Object2ObjectOpenHashMap<>(LodTexCalc.texInOneAxisCount* LodTexCalc.texInOneAxisCount);
    }
    ...
    public void removeTexture(Vector2i worldPos) {
        ...
        if (atlasCoords != null) {
            ...
            PlanetShine.logError("can't remove texture that was already removed");
        }
    }
