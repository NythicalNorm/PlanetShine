...
public class KeyBindings {
    ...
    public static final String KEY_CATEGORY_SPACECRAFT_CONTROL = "key.category.planetshine.spacecraft_control";
    public static final String KEY_INCREASE_THROTTLE = "key.planetshine.increase_throttle";
    public static final String KEY_DECREASE_THROTTLE = "key.planetshine.decrease_throttle";
    public static final String KEY_STAGING = "key.planetshine.staging";
    public static final String KEY_RCS_TOGGLE = "key.planetshine.rcs_toggle";
    public static final String KEY_SAS_TOGGLE = "key.planetshine.sas_toggle";
    public static final String KEY_DOCKING_MODE_TOGGLE = "key.planetshine.docking_mode_toggle";

    public static final String KEY_CLOCKWISE_SPIN = "key.planetshine.clockwise_spin";
    public static final String KEY_ANTI_CLOCKWISE_SPIN = "key.planetshine.anti_clockwise_spin";
