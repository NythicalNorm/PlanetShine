...
public class PlayerSpacecraftScreen extends MouseLookScreen {
    ...
    public PlayerSpacecraftScreen(LocalPlayer player, PSClient css) {
    ...
    public void sendInputs(ClientPlayerOrbitBody body) {
        body.processLocalMovement(ADAxis.getAxisValue(), SWAxis.getAxisValue(), QEAxis.getAxisValue(), CtrlShiftAxis.getAxisValue(), throttleAxis.getAxisValue(), SAS, RCS, dockingMode);
    }
}
