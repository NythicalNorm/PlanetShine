...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    private ItemModelBuilder simpleItem(RegistryObject<Item> item) {
        ...
        return  withExistingParent(item.getId().getPath(),
                ...
                ResourceLocation.fromNamespaceAndPath(VoxelSpaceProgram.MODID, "item/" + item.getId().getPath()));
    }
...
//        ModelFile.ExistingModelFile val = getExistingFile(ResourceLocation.fromNamespaceAndPath(VoxelSpaceProgram.MODID, "item/" + item.getId().getPath() + "_3d"));
//
